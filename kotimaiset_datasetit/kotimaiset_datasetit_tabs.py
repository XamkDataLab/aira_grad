import gradio as gr
from db import *
from kotimaiset_datasetit.palotapahtumat import *
from kotimaiset_datasetit.vasteet import *
import pandas as pd
from kotimaiset_datasetit.vakiluvut import *
from kotimaiset_datasetit.tieliikenneonnettomuudet import build_traffic_accidents_tab
from pestel import build_pestel_tab
...
def build_kotimaiset_datasetit_tab(demo):
    with gr.Tabs(elem_classes="subtabs"):
        ...
        with gr.TabItem("Delfoi-asiantuntija"):
            build_pestel_tab(demo)
        
        with gr.TabItem("Tieliikenneonnettomuudet"):
            build_traffic_accidents_tab(demo) 
